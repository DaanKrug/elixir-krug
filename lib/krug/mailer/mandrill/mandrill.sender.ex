defmodule Krug.MandrillSender do
  
  @moduledoc """
  A module to simplify use of Bamboo SMTP mailing
  with the "Mandrill" smtp provider.
  
  Documentation at https://www.mandrill.com
  """
  ...
  @doc """
  Send mail over "Mandrill" smtp provider. 
  ...
  iex > Krug.MandrillSender.mail(email_configuration,"Lets Party","Party Tommorow at 18:30","any@any.com")
  false
  ```
  ```elixir
  iex > email_configuration = %{
