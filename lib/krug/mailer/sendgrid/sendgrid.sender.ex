defmodule Krug.SendgridSender do
  
  @moduledoc """
  A module to simplify use of Bamboo SMTP mailing
  with the "Sendgrid" smtp provider.
  
  Documentation at https://sendgrid.com/solutions/smtp-service/
  """
  ...
  @doc """
  Send mail over "SendgridSender" smtp provider. 
  ...
  iex > Krug.SendgridSender.mail(email_configuration,"Lets Party","Party Tommorow at 18:30","any@any.com")
  false
  ```
  ```elixir
  iex > email_configuration = %{
