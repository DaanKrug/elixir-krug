defmodule Krug.GoogleMailSender do
  
  @moduledoc """
  A module to simplify use of Bamboo SMTP mailing
  with the "Google" smtp provider.
  
  Documentation at https://google.com
  """
  ...
  @doc """
  Send mail over "Google" smtp provider. 
  ...
  iex > Krug.GoogleMailSender.mail(email_configuration,"Lets Party","Party Tommorow at 18:30","any@any.com")
  false
  ```
  ```elixir
  iex > email_configuration = %{
