defmodule Krug.SendPulseSender do
  
  @moduledoc """
  A module to simplify use of Bamboo SMTP mailing
  with the "SendPulse" smtp provider.
  
  Documentation at https://sendpulse.com/features/transactional
  """
  ...
  @doc """
  Send mail over "SendPulse" smtp provider. 
  ...
  iex > Krug.SendPulseSender.mail(email_configuration,"Lets Party","Party Tommorow at 18:30","any@any.com")
  false
  ```
  ```elixir
  iex > email_configuration = %{
