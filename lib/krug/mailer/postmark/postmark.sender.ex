defmodule Krug.PostMarkSender do
  
  @moduledoc """
  A module to simplify use of Bamboo SMTP mailing
  with the "PostMark" smtp provider.
  ...
  @doc """
  Send mail over "PostMark" smtp provider. 
