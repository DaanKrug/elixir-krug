defmodule Krug.IagenteSender do
  
  @moduledoc """
  A module to simplify use of Bamboo SMTP mailing
  with the "Iagente" smtp provider.
  
  Documentation at https://www.iagente.com.br
  """
  ...
  @doc """
  Send mail over "Iagente" smtp provider. 
  ...
  iex > Krug.IagenteSender.mail(email_configuration,"Lets Party","Party Tommorow at 18:30","any@any.com")
  false
  ```
  ```elixir
  iex > email_configuration = %{
