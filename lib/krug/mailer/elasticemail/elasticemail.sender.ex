defmodule Krug.ElasticEmailSender do

  @moduledoc """
  A module to simplify use of Bamboo SMTP mailing
  with the "Elastic Email" smtp provider.
  
  Documentation at https://elasticemail.com
  """
  ...
  @doc """
  Send mail over "Elastic Email" smtp provider. 
  ...
  iex > Krug.ElasticEmailSender.mail(email_configuration,"Lets Party","Party Tommorow at 18:30","any@any.com")
  false
  ```
  ```elixir
  iex > email_configuration = %{
    ...
    try do
  	  try do
  	    credentials = %{server: "smtp.elasticemail.com", 
  	                    ...
  	                    password: email_configuration.sender_password, port: 2525}
