defmodule Krug.SendinBlueSender do
  
  @moduledoc """
  A module to simplify use of Bamboo SMTP mailing
  with the "Sendin Blue" smtp provider.
  
  Documentation at https://www.sendinblue.com
  """
  ...
  @doc """
  Send mail over "Sendin Blue" smtp provider. 
  ...
  iex > Krug.SendinBlueSender.mail(email_configuration,"Lets Party","Party Tommorow at 18:30","any@any.com")
  false
  ```
  ```elixir
  iex > email_configuration = %{
